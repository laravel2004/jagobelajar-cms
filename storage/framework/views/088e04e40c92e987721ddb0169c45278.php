    ...
    <section class="relative overflow-hidden bg-[#f9f9ff] py-12 sm:py-16">
        ...
        <div class="jb-container relative">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <h1 class="mt-5 text-3xl font-extrabold tracking-tight text-[#141b2c] sm:text-5xl"><?php echo e($content->feature_title ?? 'Belajar lebih terarah, progres lebih kelihatan'); ?></h1>
            ...
            <div class="mt-10 grid gap-5 md:grid-cols-3">
                <?php $__currentLoopData = ($content->feature_items ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="group rounded-3xl bg-white p-6 shadow-[0_14px_34px_rgba(20,27,44,0.08)] ring-1 ring-[#e9edff] transition hover:-translate-y-1 hover:shadow-[0_18px_44px_rgba(20,27,44,0.14)]">
                        <div class="grid h-12 w-12 place-items-center rounded-2xl <?php echo e($item['badge'] ?? 'bg-[#dce1ff] text-[#0043c6]'); ?>">
                            <?php switch($item['icon'] ?? 'users'):
                                case ('teacher'): ?>
                        ...
                        <h2 class="mt-5 text-xl font-extrabold text-[#141b2c]"><?php echo e($item['title'] ?? '-'); ?></h2>
                        <p class="mt-3 text-sm leading-7 text-[#5f667d]"><?php echo e($item['description'] ?? '-'); ?></p>
                    </article>
...
<?php endif; ?>
<?php /**PATH /Users/laravel2004/dev/jagobelajar-cms/resources/views/pages/public/keunggulan.blade.php ENDPATH**/ ?>