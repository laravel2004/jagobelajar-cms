...
<aside id="admin-sidebar" class="fixed left-0 top-0 z-50 h-screen w-72 -translate-x-full border-r border-[#e6eaf5] bg-white shadow-[24px_0_60px_rgba(20,27,44,0.16)] transition-transform duration-200 lg:static lg:h-screen lg:translate-x-0 lg:shadow-none">
    <div class="flex h-full flex-col">
        ...
        <nav class="flex flex-col gap-2 px-4 py-4 text-sm font-semibold">
            <a class="block rounded-xl bg-[#f1f3ff] px-4 py-3 text-[#0043c6]" href="<?php echo e(route('admin.dashboard')); ?>">Dashboard</a>
            <a class="block rounded-xl px-4 py-3 text-[#64708b] transition hover:bg-[#f6f8ff] hover:text-[#0043c6]" href="<?php echo e(route('admin.cms-beranda.edit')); ?>">CMS Beranda</a>
            <a class="block rounded-xl px-4 py-3 text-[#64708b] transition hover:bg-[#f6f8ff] hover:text-[#0043c6]" href="<?php echo e(route('materials.index')); ?>">Materi</a>
            <a class="block rounded-xl px-4 py-3 text-[#64708b] transition hover:bg-[#f6f8ff] hover:text-[#0043c6]" href="<?php echo e(route('quizzes.index')); ?>">Latihan Soal</a>
            <a class="block rounded-xl px-4 py-3 text-[#64708b] transition hover:bg-[#f6f8ff] hover:text-[#0043c6]" href="<?php echo e(route('forum.index')); ?>">Forum</a>
        </nav>
