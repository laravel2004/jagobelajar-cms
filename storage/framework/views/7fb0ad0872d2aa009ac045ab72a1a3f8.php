...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div x-data="{ count: <?php echo e(strlen(old('excerpt', $post->excerpt ?? ''))); ?> }">
                        <label class="text-sm font-bold text-[#141b2c]">Ringkasan</label>
                        <textarea name="excerpt" rows="5" maxlength="1000" x-on:input="count = $event.target.value.length" class="mt-2 w-full rounded-xl border-[#d9def1] px-4 py-3 text-sm"><?php echo e(old('excerpt', $post->excerpt)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH /Users/laravel2004/dev/jagobelajar-cms/resources/views/pages/admin/blogs/form.blade.php ENDPATH**/ ?>