    ...
    <div class="jb-container flex items-center justify-between gap-4 py-4">
        ...
        <nav class="hidden items-center gap-8 text-sm font-medium text-[#434655] lg:flex">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route(auth()->user()->isAdmin() ? 'admin.dashboard' : 'user.dashboard')); ?>" class="font-semibold text-[#0043c6] transition hover:text-[#003ab1]">Dashboard</a>
    ...
    >
        ...
        >
            ...
            <div class="space-y-3 border-t border-[#e9edff] bg-white px-5 py-5">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route(auth()->user()->isAdmin() ? 'admin.dashboard' : 'user.dashboard')); ?>" class="flex w-full items-center justify-center rounded-2xl border border-[#d9def1] bg-white px-5 py-3.5 text-sm font-bold text-[#0043c6] transition hover:bg-[#f1f3ff]" @click="open = false">
                        Dashboard
                    </a>
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/laravel2004/dev/jagobelajar-cms/resources/views/components/site-header.blade.php ENDPATH**/ ?>