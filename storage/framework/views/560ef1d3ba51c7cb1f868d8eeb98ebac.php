<nav class="sticky top-0 z-30 border-b border-[#e6eaf5] bg-white/85 px-4 py-3 backdrop-blur sm:px-6 lg:px-8">
...
<?php /**PATH C:\dev\jagobelajar-cms\resources\views\components\admin-topbar.blade.php ENDPATH**/ ?>