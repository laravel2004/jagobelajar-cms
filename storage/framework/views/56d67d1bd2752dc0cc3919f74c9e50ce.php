        ...
        <section class="rounded-2xl border border-[#e6eaf5] bg-white p-5 shadow-[0_12px_30px_rgba(20,27,44,0.04)]">
                ...
                <?php $__currentLoopData = old('feature_items', $content->feature_items ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rounded-2xl border border-[#e6eaf5] p-4 feature-item">
                        <div class="mb-3 flex items-center justify-between gap-3 text-sm font-semibold text-[#64708b]">
                            <span>Item Keunggulan <?php echo e($index + 1); ?></span>
                        ...
                        <input name="feature_items[<?php echo e($index); ?>][badge]" value="<?php echo e($item['badge'] ?? ''); ?>" class="mb-3 w-full rounded-xl border-[#d9def1] px-4 py-3 text-sm" placeholder="Class badge">
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="mt-6 grid gap-4 lg:grid-cols-3">
                ...
                <?php $__currentLoopData = old('program_items', $content->program_items ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="rounded-2xl border border-[#e6eaf5] p-4 program-item" data-program-index="<?php echo e($index); ?>">
                        ...
                        <input name="program_items[<?php echo e($index); ?>][background]" value="<?php echo e($item['background'] ?? ''); ?>" class="mb-3 w-full rounded-xl border-[#d9def1] px-4 py-3 text-sm" placeholder="Class background">
                        <input name="program_items[<?php echo e($index); ?>][url]" value="<?php echo e($item['url'] ?? ''); ?>" class="w-full rounded-xl border-[#d9def1] px-4 py-3 text-sm" placeholder="URL redirect">
                        <div class="mt-4 space-y-3 program-points">
                            <?php $__currentLoopData = array_values($points); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pointIndex => $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="program-point-row rounded-xl border border-dashed border-[#d9def1] p-3">
                                    <input name="program_items[<?php echo e($index); ?>][points][<?php echo e($pointIndex); ?>][title]" value="<?php echo e($point['title'] ?? ''); ?>" class="mb-2 w-full rounded-xl border-[#d9def1] px-4 py-3 text-sm" placeholder="Poin <?php echo e($pointIndex + 1); ?>">
                                    <input name="program_items[<?php echo e($index); ?>][points][<?php echo e($pointIndex); ?>][description]" value="<?php echo e($point['description'] ?? ''); ?>" class="w-full rounded-xl border-[#d9def1] px-4 py-3 text-sm" placeholder="Deskripsi poin">
...
<?php /**PATH /Users/laravel2004/dev/jagobelajar-cms/resources/views/pages/admin/home-content.blade.php ENDPATH**/ ?>