...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Dashboard User - '.config('app.name'))]); ?>
    <section class="jb-container py-12 sm:py-16">
        <h1 class="text-3xl font-extrabold text-[#141b2c]">Dashboard User</h1>
        <p class="mt-3 text-sm leading-7 text-[#5f667d]">Dashboard khusus user biasa. Nanti bisa isi progress belajar, jadwal try out, dan riwayat kelas.</p>
    </section>
