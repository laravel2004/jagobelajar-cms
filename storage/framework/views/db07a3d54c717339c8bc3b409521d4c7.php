            ...
            <div class="rounded-[2rem] bg-white p-6 shadow-[0_18px_50px_rgba(20,27,44,0.12)] ring-1 ring-[#e9edff] sm:p-8">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <h1 class="mt-2 text-3xl font-extrabold text-[#141b2c]"><?php echo e($bimbel?->name ?? 'Bimbel'); ?></h1>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    ...
                    <?php if(! $isPending && $bimbel?->grup_wa): ?>
                        <a href="<?php echo e($bimbel->grup_wa); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-2xl bg-[#feb700] px-5 py-3 text-sm font-bold text-[#271900]">Masuk ke Forum</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\dev\jagobelajar-cms\resources\views/pages/public/bimbel-payment-success.blade.php ENDPATH**/ ?>