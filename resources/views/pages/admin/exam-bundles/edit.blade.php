            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="jenjang_id" class="w-full rounded-lg border border-gray-300 p-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                            <option value="">-- Pilih Jenjang --</option>
                            @foreach ($jenjangs as $j)
                                <option value="{{ $j->id }}" {{ old('jenjang_id', $examBundle->jenjang_id) == $j->id ? 'selected' : '' }}>{{ $j->name }}</option>
                            @endforeach
                        </select>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div class="space-y-4">
                    ...
                    <div x-data="{ isFreePackageActive: {{ old('is_free_package_active', $examBundle->is_free_package_active) ? 'true' : 'false' }} }">
                        ...
                        <div x-show="isFreePackageActive" x-transition class="mt-3 p-4 bg-white border border-emerald-100 rounded-lg shadow-sm grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="datetime-local" name="free_package_start_date" value="{{ old('free_package_start_date', optional($examBundle->free_package_start_date)->format('Y-m-d\TH:i')) }}" class="w-full rounded-lg border border-gray-300 p-2.5 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="free_package_end_date" value="{{ old('free_package_end_date', optional($examBundle->free_package_end_date)->format('Y-m-d\TH:i')) }}" class="w-full rounded-lg border border-gray-300 p-2.5 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500">
